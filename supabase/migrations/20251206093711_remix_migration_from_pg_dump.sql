...
--
-- Name: purchases purchases_user_id_ebook_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchases
    ADD CONSTRAINT purchases_user_id_ebook_id_key UNIQUE (user_id, ebook_id);
...
--
-- Name: idx_purchases_ebook; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_purchases_ebook ON public.purchases USING btree (ebook_id);
...
--
-- Name: purchases purchases_ebook_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.purchases
    ADD CONSTRAINT purchases_ebook_id_fkey FOREIGN KEY (ebook_id) REFERENCES public.ebooks(id) ON DELETE CASCADE;
